...
export class Namespace<TIndexMetadata extends Record<string, unknown> = Record<string, unknown>> extends Index<TIndexMetadata> {
	...
	delete = (args: CommandArgs<typeof DeleteCommand>) => new DeleteCommand(args, { namespace: this.namespace }).exec(this.client);
